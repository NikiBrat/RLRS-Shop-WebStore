...
// ---------------------------------------------------------------------------------------
                    // Kod za brisanje artikla iz paketa

              if (isset($_GET['SastavID'])) 
              {

                $paket=$_SESSION['PaketID'];

                $upit = "delete from sastavpaketa where SastavID=".$_GET['SastavID']." and PaketID=".$paket;
...
// ---------------------------------------------------------------------------------------
              ...
              {
                print('<div class="alert alert-primary alert-dismissible fade show" role="alert">
                      <strong>Obaveštenje</strong> Nema artikala trenutno u ponudi!
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                      </button>
                      </div>');
...
// ---------------------------------------------------------------------------------------
                    // Kod za ubacivanje artikala u paket
              ...
              if (isset($_GET['SifraArtikla'])) 
              {
                ...
                {
                  print('<div class="alert alert-primary alert-dismissible fade show" role="alert">
                      <strong>Obaveštenje</strong> Nema artikala trenutno an stanju!
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                      </button>
                      </div>');
...
// ---------------------------------------------------------------------------------------
                    // Kod za prikaz artikala koji se nalaze u paketu
              ...
              if ($rez->num_rows>0) 
              {
                ...
                while ($row=$rez->fetch_assoc()) 
                {
                  ...
                  <td><div class='custom-control custom-switch'>
                            ...
                            <label class='custom-control-label' for='customSwitch1'>Usluga</label>
                            </div></td>
                  <td>".$row['Kolicina']."</td>
                  <td><a name='izbaci' class='btn btn-outline-danger' href='izmeniBundle.php?SastavID=".$ID."'>Izbaci</a></td>
                  </tr>";
                }
                $message .= "</table><br>";
                echo $message;
...
// ---------------------------------------------------------------------------------------
                    // Kod za ispis artikala koji nisu u ovom paketu
              ...
              if ($rez->num_rows>0) 
              {
                ...
                $message .= "<h4 class='boja'>Prikaz artikala koji nisu u ovom paketu:</h4> <br>"
                ."<table class='table table-dark table-striped'> 
                <th>Sifra Artikla</th>
                <th>Naziv</th>
                <th>Opis</th>
                ...
                while ($row=$rez->fetch_assoc()) 
                {
                  ...
                  <td>".$row['Kolicina']."</td>
                  <td><a name='dodaj' class='btn btn-outline-success' href='izmeniBundle.php?SifraArtikla=".$ID."'>Dodaj</a></td>
                  </tr>";
                }
                $message .= "</table><br>";
                echo $message;
              ...
              {
                 print('<div class="alert alert-primary alert-dismissible fade show" role="alert">
                      <strong>Obaveštenje</strong> Nema artikala, dogodila se neka Greška!
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                      </button>
                      </div>');
